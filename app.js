...
// function swag(a, b) {
//   var whatIs = a / b;
//   var meSS = `the product of$ {a} and ${b}is ${whatIs}`;
//   console.log(whatIs, meSS);
//   return [whatIs, meSS];
// }
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var sumMess = `${a} and ${b} and ${c} sum to ${sumTwo}.`;
  var multiOne = multiply(a, b)[0];
  var multiTwo = multiply(c, multiOne)[0];
  var proDuct = `The product of ${a} and ${b} and ${c} is ${multiTwo}.`;
  return [sumTwo, multiTwo, sumMess, proDuct];
...
//a = sumArr[0]   b = sumArr[1]    c = sumArr[0]
